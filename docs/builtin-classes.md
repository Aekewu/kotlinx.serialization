...
> the [Allowing special floating point values](json-configuration.md#allowing-special-floating-point-values) section.
...
> It can be lifted as shown in [Allowing structured map keys](json-configuration.md#allowing-structured-map-keys) section.
